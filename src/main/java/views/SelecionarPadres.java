 ...
 * @author raquelmelo
 */
public class SelecionarPadres extends javax.swing.JFrame {
	...
	BaseDAO baseDAO;
	List<Pessoa> padres;
    public SelecionarPadres() {
        try {
			baseDAO = new BaseDAO();
			PessoaDAO pessoaDAO = new PessoaDAOImp(baseDAO);
			padres = pessoaDAO.queryForEq("PADRE",true);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("SELEÇÃO DE PADRES");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SelecionarPadres.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SelecionarPadres().setVisible(true);
            }
        });
    }
    private String[][] todosOsPadres()
    {
    	String[][] padres = new String[this.padres.size()][3];
    	for(int i=0;i<this.padres.size();i++)
    	{
    		Pessoa padre = this.padres.get(i);
    		String[] padre1 = new String[3];
    		padre1[0] = padre.getNomeUsual();
    		padre1[1] = padre.getTelefone();
    		padre1[2] = null;
    		padres[i] = padre1;
    	}
    	return padres;
